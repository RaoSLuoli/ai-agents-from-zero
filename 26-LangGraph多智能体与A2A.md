...
**学习建议：** 这章先分层，再写代码：多智能体是应用内怎么分工，MCP 是模型应用怎么接外部能力，A2A 是不同智能体系统之间怎么协作。建议先画一张“谁和谁通信、传什么、边界在哪里”的小表，再看 Supervisor、Handoff 和 Agent Skills。第一遍不必背 A2A 规范细节，先把概念层级拆开。
...
请继续看 [第 27 章 Agent Skills 智能体技能与 AI 编程工具实践](27-Agent%20Skills智能体技能与AI编程工具实践.md)。
