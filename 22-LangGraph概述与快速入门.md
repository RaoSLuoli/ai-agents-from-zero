...
**学习建议：** 这一章只负责让你建立 LangGraph 的第一张图，不用把后面所有 API 一次学完。先把 State、Node、Edge、Graph 四个词放到一个最小案例里理解：状态怎么进图，节点怎么改状态，边怎么决定下一步。更细的状态合并看 [第 23 章](23-LangGraphAPI：图与状态.md)，节点和控制流看 [第 24 章](24-LangGraphAPI：节点、边与进阶.md)，高级能力再放到 [第 25 章](25-LangGraph高级特性.md) 和 [第 26 章](26-LangGraph多智能体与A2A.md)。
